...
_Timeout = param[4];
_patrol = param[5];
_models = [(SelectRandom _Model),(SelectRandom _Model),(SelectRandom _Model),(SelectRandom _Model),(SelectRandom _Model)];
...
_pCount = SelectRandom [0,45,90,135,180,225,270,315];
_way2Pos = [_DropHeliV, 5000, _pCount] call BIS_fnc_relPos;
