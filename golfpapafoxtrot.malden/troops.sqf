...
If (Side _plyr == west) Then {[_plyr,'B_Heli_Light_01_F',_bModels] Call GPF_fnc_playerSupport;};
If (Side _plyr == east) Then {[_plyr,'O_Heli_Light_02_unarmed_F',_oModels] Call GPF_fnc_playerSupport;};
If (Side _plyr == resistance) Then {[_plyr,'I_Heli_light_03_unarmed_F',_rModels] Call GPF_fnc_playerSupport;};
If (Side _plyr == civilian) Then {[_plyr,'B_Heli_Light_01_F',_cModels] Call GPF_fnc_playerSupport;};